import React, {ForwardRefExoticComponent, Fragment, RefAttributes, useRef} from "react";
...
const SharedModal = (props: ISharedModal) => {
    const divRef = useRef(null);
    const {BodyContent, show, setShow} = props;
