...
import CloudTriangleMd from "./component/graphics/CloudTriangleMd";
      ...
      <div className="App">
        ...
        <Section title=''>
          <div className='grid grid-cols-12 gap-4'>
            <div className='col-span-10 md:col-span-3 xl:col-span-2 text-center md:text-right self-center'>
              <h3 className='font-bold text-5xl text-obsidian'>Three Words Payoff</h3>
            </div>
            <div className='col-span-12 md:col-span-9 xl:col-span-10 self-center line-clamp-6'>
